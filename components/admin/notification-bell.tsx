...
export function NotificationBell({ notifications, unreadCount }: { notifications: Notification[] | null; unreadCount: number }) {
  return (
    <Popover>
      ...
      <PopoverContent className="w-80 p-0" align="end" sideOffset={8}>
        ...
        <div className="border-t border-border px-4 py-2">
          <Link
            ...
            className="block text-center text-xs text-muted-foreground underline underline-offset-4 transition hover:text-foreground"
          >
