...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn("fixed top-4 right-4 z-[100] flex max-w-sm flex-col gap-2", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close ref={ref} className={cn("absolute top-3 right-3 text-muted-foreground", className)} {...props}>
    <X className="h-4 w-4" />
